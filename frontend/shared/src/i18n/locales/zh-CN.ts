...
export const zhCN = {
  ...
  admin: {
    ...
    auth: { signInTitle: "管理后台登录", email: "邮箱", password: "密码", submit: "登录" },
    dashboard: {
      title: "运营总览",
      subtitle: "先看异常，再看业务。",
      alerts: {
      ...
      health: { runningOperations: "进行中操作", activeUsers: "活跃用户" },
      commerce: { revenueTotal: "累计收款", paymentsByStatus: "支付状态分布" },
    },
    common: {
      email: "邮箱",
      status: "状态",
